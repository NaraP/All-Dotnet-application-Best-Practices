   ...
   public class EmailManager
    {
        ...
        const string DEFAULT_MAIL_SERVER_NAME = "Company outlook emialI";
        #endregion
        ...
        public void SendMail()
        {
            ...
            try
            {
                ...
                if (toMailList != null)
                {
                    ...
                    {
                        if (!string.IsNullOrEmpty(mailId) && !mailId.ToLower().Contains("Test@gmail.com") && !mailId.ToLower().Contains("Test@gmail.com") && !mailId.ToLower().Contains("Test@gmail.com"))
                            mail.To.Add(mailId);
                    }
                }
                ...
                if (_fromMail.ToLower() == "GroupEmailid@gmail.com")
                {
                ...
                if (_fromMail.ToLower() == "DLname@gmail.com")
                {

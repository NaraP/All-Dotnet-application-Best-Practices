<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCustomerDetails.aspx.cs" Inherits="WCFClientWebApplication.FrmCustomerDetails" %>
...
<body>
    ...
    <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
        <tr>
            ...
            <td style="width: 100px">
                <asp:Button ID="btnAdd" runat="server" Text="Add New" OnClick="btnAdd_Click" Width="103px" Height="27px" />
            </td>
        </tr>
    </table>
    </form>
